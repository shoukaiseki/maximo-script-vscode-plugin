 ...
 * 脚本(AUTOSCRIPT): SHARPTREE.AUTOSCRIPT.STORE
 * 脚本语言(SCRIPTLANGUAGE): nashorn
 * 描述(DESCRIPTION): Sharptree Automation Script Storage Script
 * 日志级别(LOGLEVEL): ERROR
 * 唯一标识(AUTOSCRIPTID): 250            语言代码(LANGCODE): ZH
 * 用户定义(USERDEFINED): Y               状态(STATUS): Draft
 * 是接口(INTERFACE): N                  活动(ACTIVE): Y
 * 变更人(CHANGEBY): MAXADMIN
 * 日期(CHANGEDATE): 2026/5/20 18:19:12
 *
 * Variables: 无
 *
 * Launch Points: 无
