 ...
 * 脚本(AUTOSCRIPT): SHARPTREE.AUTOSCRIPT.DEPLOY.HISTORY
 * 脚本语言(SCRIPTLANGUAGE): nashorn
 * 描述(DESCRIPTION): Automation Script Deploy History
 * 日志级别(LOGLEVEL): ERROR
 * 唯一标识(AUTOSCRIPTID): 224            语言代码(LANGCODE): ZH
 * 用户定义(USERDEFINED): Y               状态(STATUS): Draft
 * 是接口(INTERFACE): N                  活动(ACTIVE): Y
 * 变更人(CHANGEBY): MAXADMIN
 * 日期(CHANGEDATE): 5/19/26 8:45 AM
 *
 * Variables: 无
 *
 * Launch Points: 无
